...
function init_flot_chart() {
    ...
    if ("undefined" != typeof $.plot) {
        ...
        for (var a = [
            [gd(year, month, day - 7), 17],
            [gd(year, month, day - 6), 74],
            [gd(year, month, day - 5), 6],
            [gd(year, month, day - 4), 39],
            [gd(year, month, day - 3), 20],
            [gd(year, month, day - 2), 85],
            [gd(year, month, day - 1), 7]
        ], b = [
        ...
        $("#chart_plot_01").length && (console.log("Plot1"), $.plot($("#chart_plot_01"), [a, b], g)), $("#chart_plot_021").length && (console.log("Plot2"), $.plot($("#chart_plot_021"), [{
